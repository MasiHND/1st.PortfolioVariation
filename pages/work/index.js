    ...
    <div className="h-full bg-primary/30 py-36 flex items-center">
      ...
      <div className="container mx-auto">
        <div className="flex flex-col xl:flex-row gap-x-8">
          {/* text */}
          <div className="text-center flex flex-col lg:flex-row lg:gap-x-20 xl:flex-col xl:gap-0 xl:w-[30vm] lg:text-left mb-4 xl:mb-0">
            <motion.h2
              variants={fadeIn("right", 0.4)}
              initial="hidden"
              animate="show"
              exit="hidden"
              className="h2 lg:text-5xl xl:h2 xl:mt-16"
            >
            ...
            <motion.p
              ...
              animate="show"
              exit="hidden"
              className="mb-4 max-w-[400px] lg:max-w-[600px] xl:max-w-[400px]: mx-auto lg:mx-0"
            >
